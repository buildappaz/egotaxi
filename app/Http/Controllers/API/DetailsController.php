...
public function getContacts(Request $request){
    ...
    $tel="+994705202209";
    $whtp="+994775896699";
    $mail="info@egotaxi.az";


    $result=[
        "az"=>[
        "title" => "Bizimle əlaqə",
        "descriptions" => "Etrafli melumat",
        "contact_list" => [
             ["name" => "tel", "value" => $tel],
            ["name" => "WP", "value" => $whtp],
...
public function getAbouts()
{
    ...
    $result=[
        "az"=>[
        "title" => "Haqqımızda",
        "descriptions" => "Beynəlxalq Biznes Kataloq olaraq sizlərin biznesinizin daha yaxından tanımaq üçün yeni xidmət fəaliyyətimizlə görüşünüzə gəlirik. Fəaliyyət istiqamətimiz sizin biznesinizi istifadəçilərə tanıtmaq və biznesinizi yüksəltməkdir. Beynəlxalq Biznes Kataloqu bütün dünya xalqlarının şirkət, biznes, xidmət və s.sahələrinin bir araya gətirən məkandır. Beynəlxalq Biznes Kataloqu istehsalçı və istehlakçı arasında bir vasitəçi körpüdür. Beləliklə istifadəçilər istənilən şirkət, biznes, xidmət və s.sahələr üzrə daha tez və dəqiq məlumat öyrənə biləcəklər.Unutmayın, xidmətimiz xidmətinizdir!

Qaydalar..! VisitCatalogue saytına yerləşdirilmiş məlumatların məzmunu haqqında VisitCatalogue saytı heç bir məsuliyyət daşımır. Məlumatlari böyük həriflərlə və daxilində digər işarələr ilə (məsələn: +,-,), (,!,$,%,&, *, və s.) yerləşdirmək qadağandır, əks halda məlumat qəbul olunmayacaq. VisitCatalogue saytına yerləşdirilmiş məlumatlar 1il (bir il) müddətində qüvvədə qalır. VisitCatalogue saytına yerləşdirilən qanunlara zidd olan məlumatlar, tanışlıq, 18+ xarakterli məlumatların yerləşdirilməsi qadağandır əks halda məlumat qəbul olunmayacaq. Məlumat admin tərəfindən yoxlandıqdan sonra saytda dərc ediləcək.

Beynəlxalq Biznes Kataloq olaraq sizlərin biznesinizin daha yaxından tanımaq üçün yeni xidmət fəaliyyətimizlə görüşünüzə gəlirik. Fəaliyyət istiqamətimiz sizin biznesinizi istifadəçilərə tanıtmaq və biznesinizi yüksəltməkdir. Beynəlxalq Biznes Kataloqu bütün dünya xalqlarının şirkət, biznes, xidmət və s.sahələrinin bir araya gətirən məkandır. Beynəlxalq Biznes Kataloqu istehsalçı və istehlakçı arasında bir vasitəçi körpüdür. Beləliklə istifadəçilər istənilən şirkət, biznes, xidmət və s.sahələr üzrə daha tez və dəqiq məlumat öyrənə biləcəklər.Unutmayın, xidmətimiz xidmətinizdir!
...
return response()->json($result,200);
    ...
    {      
        if(Auth::attempt(['contact_number' => request('phone_number'), 'password' => request('password'), 'user_type' => request('user_type')])){
