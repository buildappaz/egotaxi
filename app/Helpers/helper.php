...
function egotaxi_get_distance_matrix($pick_lat, $pick_lng, $drop_lat, $drop_lng, $traffic = false) {
    $google_map_api_key = env('GOOGLE_MAP_KEY');
...
function egotaxi_get_distance_between($pick_lat, $pick_lng, $drop_lat, $drop_lng, $traffic = false) {
  ...
  $unit='km';
    ...
    $earthRadius = ($unit == 'km') ? 6371 : 3959; // Dünya yarıçapı (km veya mil)
...
// function egotaxi_get_distance_matrix($getOrigins, $getDestinations, $traffic = false) {

//     // $origins=array($pick_lat,$pick_lng);

//     // $destinations = array("40.41719,-3.68419", "40.41561,-3.70337", "40.40922,-3.71099", "40.39992,-3.70028");

//     $origins=$getOrigins; //array($pick_lat,$pick_lng);

//     $destinations =$getDestinations;  //array("40.41719,-3.68419", "40.41561,-3.70337", "40.40922,-3.71099", "40.39992,-3.70028");
...
//     $response = Http::withHeaders([
//         'Accept-Language' => request('language'),
//     ])->get('https://maps.googleapis.com/maps/api/distancematrix/json?origins='.implode('|', $origins).'&destinations='.implode('|', $destinations).'&key='.$google_map_api_key.'&mode=driving');
