...
//test 
Route::get('send-noty',[API\UserController::class,'sendNotification']);

Route::get('send-new-request',[API\UserController::class,'sendNewRequest']);

// test end 

//Riders
Route::post('rider/login',[API\UserController::class,'loginRider']);
Route::post('check-user-with-phone',[API\UserController::class, 'accountControlWithPhone']); 
Route::post('update-rider-info',[API\UserController::class, 'updateRiderInfo']); 

Route::post('riderequest-calculate-price',[API\RideRequestController::class, 'calculateRideRequestPrice']);  

Route::post('riderequest-send-new',[API\RideRequestController::class, 'saveNewRideRequest']);  

Route::get('current-riderequest-status',[API\RideRequestController::class, 'currentRiderequestStatus']);   



Route::post('change-request-status',[API\RideRequestController::class, 'changeRiderequestStatus']);  
Route::post('driver/change-request-status-driver',[API\RideRequestController::class, 'changeRiderequestStatusInDriver']);  

Route::get('get-contacts',[API\DetailsController::class, 'getContacts']);  

Route::get('get-about',[API\DetailsController::class, 'getAbouts']);  
...
Route::post('driver/login',[API\UserController::class,'loginDriver']);
Route::post('driver/register',[API\UserController::class,'registerDriver']);

Route::post('driver/forget-password',[ API\UserController::class,'forgetPasswordDriver']);

Route::post('driver/change-status',[ API\UserController::class,'changeDriverStatus']); 


Route::get('driver/get-details',[ API\UserController::class,'getDriverDetils']); 

Route::get('driver/update-position',[ API\UserController::class,'updateDriverLocation']); 
